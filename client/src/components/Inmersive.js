    ...
    return (
      <a-scene>
        ...
        <a-entity position="0 0 0">
          ...
          <a-entity
            id="ground"
            position="-199.308 3.629 230.262"
            scale="21 10 27.500"
          ...
          <a-entity
            id="ceiling"
            position="-199.928 106.298 233.193"
            scale="21 100 27.500"
            gltf-model="https://cdn.glitch.global/078ce1a5-734a-4824-8ef5-cf5a78251ea1/floor_whitetile_20x20_meters.glb?v=1692870723480"
          ></a-entity>
        </a-entity>
        ...
        <a-entity position="0 0 0">
          <a-entity
            id="sidewalkright"
            position="237.867 0.026 -15.488"
            scale="0.285 0.200 0.200"
            rotation="0 90 0"
          ...
          <a-entity
            id="cylinderone"
            position="282.606 7.817 310.944"
            scale="90 90 90"
            rotation="90 0 0"
          ...
          <a-entity
            id="cylindertwo"
            position="217.727 7.817 310.944"
            scale="90 90 90"
            rotation="90 0 0"
            gltf-model="https://cdn.glitch.me/078ce1a5-734a-4824-8ef5-cf5a78251ea1/concrete_test_cylinder_w1_1.glb?v=1693308727583"
          ></a-entity>
          ...
          <a-entity
            id="cylinderthree"
            position="152.860 7.817 310.944"
            scale="90 90 90"
            rotation="90 0 0"
            gltf-model="https://cdn.glitch.me/078ce1a5-734a-4824-8ef5-cf5a78251ea1/concrete_test_cylinder_w1_1.glb?v=1693308727583"
          ></a-entity>
          ...
          <a-entity
            id="cylinderfour"
            position="282.594 7.817 247.407"
            scale="90 90 90"
            rotation="90 0 0"
            gltf-model="https://cdn.glitch.me/078ce1a5-734a-4824-8ef5-cf5a78251ea1/concrete_test_cylinder_w1_1.glb?v=1693308727583"
          ></a-entity>
          ...
          <a-entity
            id="cylinderfive"
            position="282.594 7.817 182.540"
            scale="90 90 90"
            rotation="90 0 0"
            gltf-model="https://cdn.glitch.me/078ce1a5-734a-4824-8ef5-cf5a78251ea1/concrete_test_cylinder_w1_1.glb?v=1693308727583"
          ></a-entity>
          ...
          <a-entity
            id="cylindersix"
            position="282.594 7.817 117.673"
            scale="90 90 90"
            rotation="90 0 0"
            gltf-model="https://cdn.glitch.me/078ce1a5-734a-4824-8ef5-cf5a78251ea1/concrete_test_cylinder_w1_1.glb?v=1693308727583"
          ></a-entity>
          ...
          <a-entity
            id="sign"
            position="186.319 41.320 328.063"
            scale="90 200 100"
            rotation="0 90 0"
          ...
          <a-entity
            id="flowerone"
            position="237.202 0.877 -154.653"
            scale="1 1 1"
          ...
          <a-entity
            id="flowerthree"
            position="237.202 -2.026 122.992"
          ...
          <a-entity
            id="flowerfour"
            position="237.202 0.877 261.317"
            scale="0.100 0.100 0.100"
          ...
          <a-entity
            id="flowerfive"
            position="149.712 0.877 282.928"
            scale="0.100 0.100 0.100"
            gltf-model="https://cdn.glitch.global/078ce1a5-734a-4824-8ef5-cf5a78251ea1/white_flower.glb?v=1693311929581"
          ></a-entity>
          ...
          <a-entity
            id="flowerseven"
            position="-132.373 -2.026 280.969"
            scale="0.200 0.200 0.200"
            gltf-model="https://cdn.glitch.global/078ce1a5-734a-4824-8ef5-cf5a78251ea1/colored_flower.glb?v=1693311926395"
          ></a-entity>
        </a-entity>
        ...
        <a-entity>
          ...
          >
            <a-entity
              ...
              camera
              look-controls
              position="15.122 30.534 370.138"
              rotation="-13.178 -2.063 0"
            ></a-entity>
          </a-entity>
          <a-entity
